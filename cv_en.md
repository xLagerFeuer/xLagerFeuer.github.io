...
- work with grants for LLM, ML, etc.
  ...
  - formation of a system design for communication between the client and the model
...
- wrote and applied machine learning algorithms
...
- Python:
  - numpy, pandas, matplotlib, sklearn, jupyter, seaborn to perfection
...
- Linux-admin middle candidate:
  ...
  - implementation of the ELK stack, incl. open-source
- DevOps
